...
Last reviewed against codebase: 2026-03-31 (commit `629615c8` + Group sync redesign + Chat sync guard + pubkey normalization + create-group auto-approve)
