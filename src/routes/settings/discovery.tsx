        ...
        <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setDiscoveryInterval(parseInt(e.target.value) || 0)
                    }
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Minimum 30s. Lower = faster updates.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setDiscoveryLimit(parseInt(e.target.value) || 0)
                    }
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Peers per gossip. Recommended: 5
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
              To be discoverable by other users and receive offline messages,
              you should register with an always-online Discovery Server (MLS).
            </p>
              ...
              <div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 p-3 rounded mb-4">
                  ...
                  <p className="text-xs text-yellow-700 dark:text-yellow-300 mt-1">
                    Do NOT use this on a mobile device. Only use if this node is
                    running on a VPS or server with a public IP.
                  </p>
                </div>

                <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                  If this node is a server, you can configure it to act as its
