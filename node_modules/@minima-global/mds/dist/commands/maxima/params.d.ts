export type MaximaAction = 'info' | 'setname' | 'hosts' | 'send' | 'sendall' | 'refresh' | 'seticon';
...
export type MaxContactsAction = 'add' | 'remove' | 'search' | 'import' | 'export' | 'list';
...
export type MaxExtraAction = 'staticmls' | 'addpermanent' | 'removepermanent' | 'listpermanent' | 'clearpermanent' | 'allowallcontacts' | 'clearallowed' | 'mlsinfo' | 'getaddress' | 'addallowed';
