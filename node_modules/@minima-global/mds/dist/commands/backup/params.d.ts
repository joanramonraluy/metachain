export type ArchiveAction = 'resync' | 'integrity' | 'export' | 'import' | 'inspect' | 'addresscheck' | 'exportraw';
...
export type VaultAction = 'seed' | 'wipekeys' | 'restorekeys' | 'passwordlock' | 'passwordunlock';
